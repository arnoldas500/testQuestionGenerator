...
/**
 * Servlet implementation class NuQuestionsServlet
 */
@WebServlet("/NuQuestionsServlet")
public class NuQuestionsServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public NuQuestionsServlet() {
        super();
